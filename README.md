...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-d2j94tu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-d2j94tu.containers.anotherwebservice.com/
...
```
git clone git@github.com:thenotlih/container-d2j94tu.git
cd container-d2j94tu
```
...
```
docker attach container-d2j94tu
```
